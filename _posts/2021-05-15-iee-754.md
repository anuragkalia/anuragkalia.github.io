...
1. [IEEE 754 - Wikipedia](https://en.wikipedia.org/wiki/IEEE_754#Character_representation)
2. The IEEE 754 standard itself
3. Visual editor for binary 32 bit numbers: [IEEE-754 Floating Point Converter (h-schmidt.net)](https://www.h-schmidt.net/FloatConverter/IEEE754.html)
